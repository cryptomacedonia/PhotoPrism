...
//    func parse(commands:[String]) -> Result {
//        var arguments = commands.dropFirst()
//
...
//    }
    ...
    func parse(listen:Listen) -> Result {
        return Result(commandString: "command",target: listen.targetHost, listen: listen)
    }
